...
const Tile = (props) =>
  (
    <div className={styles.square} onClick={props.move} style={{backgroundColor: props.color}}>
      <React.Fragment>
        <CSSTransition in={props.cell === "X"} unmountOnExit classNames={{enter: styles.cross, enterActive: styles.animate, exit: styles.cross}} timeout={1000}>
        ...
        <CSSTransition in={props.cell === "O"} unmountOnExit classNames={{enter: styles.nought, enterActive: styles.animate, exit: styles.nought}} timeout={1000}>
          <svg xmlns="http://www.w3.org/2000/svg" style={{ height: "100%",  width: "100%"}} viewBox="0 0 128 128">
